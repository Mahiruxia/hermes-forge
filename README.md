...
当前公开版本为 **v0.1.7**，已经具备可安装、可演示、可继续开发的主链路：
...
- v0.1.7 延续了稳定的 Release 资产命名，并继续补强回复稳定性、既有 Hermes 配置导入、连接器快速配置和系统能力审计。
...
- 支持导入本机既有 Hermes 配置，把模型和连接器配置迁移到 Forge 的本机配置与密钥库。
