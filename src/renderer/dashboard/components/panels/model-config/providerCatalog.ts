...
export const PROVIDERS: ProviderPreset[] = [
  ...
  provider("deepseek_api_key", "DeepSeek", "china", "需要 API Key", "https://api.deepseek.com/v1", "deepseek-v4-pro", "选择或填写 DeepSeek 模型 ID", "required", Network, "DeepSeek 官方 API", ["deepseek", "深度求索"], undefined, "api_key", ["deepseek-v4-pro", "deepseek-v4-flash", "deepseek-chat", "deepseek-reasoner"]),
  ...
  provider("mimo_api_key", "MiMo API", "china", "需要 API Key", "https://api.xiaomimimo.com/v1", "mimo-v2.5-pro", "选择或填写 MiMo 模型 ID", "required", Cloud, "小米 MiMo V2.5 按量付费 API", ["mimo", "xiaomi", "小米"], undefined, "api_key", ["mimo-v2.5-pro", "mimo-v2.5", "mimo-v2.5-flash"], ["chat"]),
  ...
  provider("volcengine_coding_api_key", "火山引擎方舟 Coding Plan", "china", "需要 API Key", "https://ark.cn-beijing.volces.com/api/coding/v3", undefined, "填写火山 Coding endpoint ID", "required", Code2, "火山引擎 Coding Plan 专用接口", ["火山", "volcengine", "coding"], "Coding Plan", "api_key", undefined, ["chat", "coding_plan"]),
  provider("dashscope_coding_api_key", "通义千问 Coding Plan", "china", "需要 API Key", "https://coding-intl.dashscope.aliyuncs.com/v1", "qwen3-coder-plus", "选择或填写 DashScope Coding 模型 ID", "required", Code2, "阿里云百炼 Coding Plan 专用接口", ["通义", "dashscope", "coding", "qwen"], "Coding Plan", "api_key", ["qwen3-coder-plus", "qwen3-max-2026-01-23", "qwen3-coder-next", "qwen3.6-plus", "qwen3.5-plus", "kimi-k2.5", "glm-5", "glm-4.7", "MiniMax-M2.5"], ["chat", "coding_plan"]),
  provider("zhipu_coding_api_key", "智谱 GLM Coding Plan", "china", "需要 API Key", "https://open.bigmodel.cn/api/coding/paas/v4", "glm-5", "选择或填写智谱 Coding 模型 ID", "required", Code2, "智谱 GLM Coding Plan 专用接口", ["智谱", "glm", "coding", "zhipu"], "Coding Plan", "api_key", ["glm-5", "glm-5.1", "glm-5-turbo", "glm-4.7", "glm-4.7-flash", "glm-4.6", "glm-4.5", "glm-4.5-air"], ["chat", "coding_plan"]),
  provider("baidu_qianfan_coding_api_key", "百度千帆 Coding Plan", "china", "需要 API Key", "https://qianfan.baidubce.com/v2/coding", undefined, "填写千帆 Coding 模型 ID", "required", Code2, "百度千帆 Coding Plan 专用接口", ["百度", "qianfan", "coding"], "Coding Plan", "api_key", undefined, ["chat", "coding_plan"]),
  provider("tencent_token_plan_api_key", "腾讯云通用 Coding Plan", "china", "需要 API Key", "https://api.lkeap.cloud.tencent.com/coding/v3", "kimi-k2.5", "选择或填写腾讯云 Coding Plan 模型 ID", "required", Code2, "腾讯云通用 Coding Plan（lkeap）接口", ["腾讯", "tencent", "coding plan", "lkeap"], "Coding Plan", "api_key", ["kimi-k2.5", "glm-5", "minimax-m2.5", "hunyuan-turbos", "hunyuan-t1", "hunyuan-2.0-thinking", "hunyuan-2.0-instruct", "tc-code-latest"], ["chat", "coding_plan"]),
  provider("tencent_hunyuan_token_plan_api_key", "腾讯云 TokenHub（混元）", "china", "需要 API Key", "https://tokenhub.tencentmaas.com/v1", "hy3-preview", "选择或填写腾讯 TokenHub 模型 ID", "required", Code2, "腾讯云混元 TokenHub 接口", ["腾讯", "hunyuan", "tokenhub", "token-plan"], "Coding Plan", "api_key", ["hy3-preview", "n-2.0-thinking-202511", "n-2.0-instruct-202511"], ["chat", "coding_plan"]),
  provider("mimo_token_plan_api_key", "MiMo Token Plan（中国区）", "china", "需要 API Key", "https://token-plan-cn.xiaomimimo.com/v1", "mimo-v2.5-pro", "选择或填写 MiMo Token Plan 模型 ID", "required", Code2, "小米 MiMo V2.5 Token Plan 中国区接口", ["mimo", "xiaomi", "小米", "token-plan"], "Coding Plan", "api_key", ["mimo-v2.5-pro", "mimo-v2.5", "mimo-v2.5-flash"], ["chat", "coding_plan"]),
  provider("minimax_token_plan_api_key", "MiniMax Token Plan", "china", "需要 API Key", "https://api.minimaxi.com/anthropic", "MiniMax-M2.7", "选择或填写 MiniMax Token Plan 模型 ID", "required", Code2, "MiniMax Token Plan（国内）接口", ["minimax", "token-plan"], "Coding Plan", "api_key", ["MiniMax-M2.7", "MiniMax-M2.7-highspeed", "MiniMax-M2.5", "MiniMax-M2.5-highspeed", "MiniMax-M2.1", "MiniMax-M2"], ["chat", "coding_plan"]),
  provider("kimi_coding_api_key", "Kimi Coding Plan", "china", "需要 API Key", "https://api.kimi.com/coding/v1", "kimi-for-coding", "选择或填写 Kimi Coding 模型 ID", "required", Code2, "Kimi Coding Plan 官方专用接口（model 固定 kimi-for-coding）", ["kimi", "coding", "moonshot", "kimi-for-coding"], "Coding Plan", "api_key", ["kimi-for-coding", "k2p6", "k2p5", "kimi-k2-thinking"], ["chat", "coding_plan"]),
