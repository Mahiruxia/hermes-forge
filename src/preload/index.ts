...
const IpcChannels = {
  ...
  respondInteraction: "task:interaction:respond",
...
const api = {
  ...
  respondInteraction: (input: EngineInteractionResponse) =>
    ipcRenderer.invoke(IpcChannels.respondInteraction, input) as Promise<{ ok: boolean; message: string }>,
